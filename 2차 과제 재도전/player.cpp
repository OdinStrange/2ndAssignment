#include "Player.h"/* Player.cpp 혹은 Player.h의 하단 */

// 생성자 구현
Player::Player(string nickname)
    : nickname(nickname), level(1), HP(50), MP(50), power(10), defence(10), accuracy(10), speed(10) {
    // 기본 직업 이름은 없음으로 초기화 (자식 클래스에서 변경)
    job_name = "초보자";
}
